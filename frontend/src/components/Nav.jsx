...
const Nav = () => {
  ...
  return (
    <div className="w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] px-[20px] fixed top-0 z-[9999] bg-[#fff9f6] overflow-visible">
      ...
      <h1 className="text-3xl font-bold mb-2  text-[#ff4d2d]">Feasty</h1>
      ...
      <div className="flex items-center gap-5">
        {showSearch? <RxCross2 className="text-[#ff4d2d] cursor-pointer md:hidden" onClick={() => setShowSearch(false)}/> : <IoIosSearch
          size={25}
