...
const TrackOrderPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 flex flex-col gap-6 ">
      <div
        className="relative top-[20px] left-[20px] z-[10] mb-[10px] flex items-center gap-4  cursor-pointer"
      ...
      {currentOrder?.shopOrders?.map((shopOrder, index) => (
        <div
          className="bg-white rounded-2xl shadow-md border p-2 border-orange-400 space-y-4"
          key={index}
        >
          <div>
